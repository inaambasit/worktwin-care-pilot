...
def _generate_source_grounded_answer(
    ...
    system_prompt = (
        ...
        "- Do not add generic escalation phrases such as "
        "\"Please escalate this to your line manager or designated lead.\" "
        "unless the source document itself explicitly instructs escalation or directs "
        "the reader to consult a manager or lead because the staff member is unsure. "
        "Reproduce only the escalation or referral wording that appears in the source — "
        "do not add any escalation language beyond what the source states.\n"
        "- Use UK English.\n"
