...
const boundaries = [
  {
    heading: 'Controlled public demo - not production software',
    text: 'This is a controlled public demo designed to show how the WorkTwin platform could work. It uses sample documents and fictional scenarios only. It is not approved for use with real staff, service-user or care data at this stage.',
  },
  {
    heading: 'No real data should be entered',
    text: 'Do not enter real staff, service-user, HR, safeguarding, medication, payroll, complaints or care-plan data into this demo at any point. Sample and fictional content only.',
  },
  {
    heading: 'Private Notes are session-only',
    text: 'Private Notes in the demo exist only in your browser session. They are not submitted to any care system, saved to a server, or retained after you close the tab.',
  },
  {
    heading: 'Personal Ask questions are private from managers',
    text: 'In this demo, personal Ask questions are not visible to managers. The demo is designed to show that this boundary is respected in the platform design.',
  },
  {
    heading: 'Practice records are not submitted to a real care system',
    text: 'Structured practice records and scenario completions may be shown in the demo but are not submitted to a real care system, external platform or regulatory database.',
  },
  {
    heading: 'Anonymous Insights show themes - not individuals',
    text: 'Anonymous Insights in the demo are designed to show themes and patterns, not individual conversations, transcripts or identifiable staff information.',
  },
  {
      ...
      <main className="pt-24 pb-20 max-w-3xl mx-auto px-6">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mb-4 leading-snug">
            How this demo handles data and privacy
          </h1>
          <p className="text-slate-600 leading-relaxed">
            This page explains the privacy boundaries for the WorkTwin Care Pilot demo.
            It is a one-minute read. Please read it before using the demo.
          </p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-8 flex gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-amber-800 mb-1">Controlled demo - not production software</p>
            <p className="text-sm text-amber-700 leading-relaxed">
              WorkTwin Care Pilot is an early-stage controlled demo. It is not approved for use with
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-6 mb-10">
          ...
          <ul className="space-y-2.5">
            {[
              'No real staff, service-user or care data should be entered into this demo.',
      ...
      <footer className="bg-slate-900 py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-500 text-xs text-center">
            Controlled demo - sample data only. No real staff, service-user or care data.
