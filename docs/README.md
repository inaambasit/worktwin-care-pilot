...
| [Pilot identity and environment decision record (4S.95A)](4s95a-pilot-identity-and-environment-decision-record.md) | Docs-only decision record -- authoritative pre-migration reference for organisation_id, new pilot Supabase project, bootstrap admin, membership model, middleware scope, admin proxy, DPA/governance prerequisites, QCS content restrictions, JWT wording, and next-slice sequence (4S.95B–4S.95I); checkpoint 04fc14c |
